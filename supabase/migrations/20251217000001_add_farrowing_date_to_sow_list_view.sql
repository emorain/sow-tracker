-- Add actual_farrowing_date to sow_list_view for nursing status calculation
...
SELECT
  ...
  -- NEW: Latest active farrowing date (for calculating nursing days)
  (
...
COMMENT ON VIEW sow_list_view IS 'Optimized view for sow list page - aggregates farrowing counts and breeding status to eliminate N+1 queries. Now includes active_farrowing_date for nursing status calculation.';
