-- Comprehensive Test Data for Sow Tracker - 50 Sows
-- Fresh version - matches current database schema exactly
...
('33333333-3333-3333-3333-000000000038', v_user_id, 'S038', 'Luna', '2021-08-27', 'Yorkshire', 'active', '11111111-1111-1111-1111-000000000002', 'Gilt, gaining weight'),
...
('55555555-5555-5555-5555-000000000016', v_user_id, '33333333-3333-3333-3333-000000000016', NULL, CURRENT_DATE - 142, CURRENT_DATE - 28, CURRENT_DATE - 28, 10, 1, 0, CURRENT_DATE - 32, CURRENT_DATE - 14, 'Weaned at 21 days'),
...
('55555555-5555-5555-5555-000000000018', v_user_id, '33333333-3333-3333-3333-000000000018', NULL, CURRENT_DATE - 140, CURRENT_DATE - 26, CURRENT_DATE - 26, 9, 1, 1, CURRENT_DATE - 30, CURRENT_DATE - 10, 'Early wean'),
('55555555-5555-5555-5555-000000000019', v_user_id, '33333333-3333-3333-3333-000000000019', NULL, CURRENT_DATE - 148, CURRENT_DATE - 34, CURRENT_DATE - 33, 12, 2, 0, CURRENT_DATE - 37, CURRENT_DATE - 16, 'Large litter'),
...
('55555555-5555-5555-5555-000000000021', v_user_id, '33333333-3333-3333-3333-000000000021', NULL, CURRENT_DATE - 138, CURRENT_DATE - 24, CURRENT_DATE - 24, 11, 1, 0, CURRENT_DATE - 28, CURRENT_DATE - 9, 'Early wean'),
('55555555-5555-5555-5555-000000000022', v_user_id, '33333333-3333-3333-3333-000000000022', NULL, CURRENT_DATE - 150, CURRENT_DATE - 36, CURRENT_DATE - 35, 10, 0, 0, CURRENT_DATE - 39, CURRENT_DATE - 18, 'Veteran sow'),
('55555555-5555-5555-5555-000000000023', v_user_id, '33333333-3333-3333-3333-000000000023', NULL, CURRENT_DATE - 141, CURRENT_DATE - 27, CURRENT_DATE - 27, 9, 1, 0, CURRENT_DATE - 31, CURRENT_DATE - 13, 'Second litter');

-- ============================================================================
-- PIGLETS (Nursing and weaned)
-- ============================================================================

-- Nursing piglets from currently farrowing sows (Group 2)
...
-- Weaned piglets in nursery (from Group 3 weaned sows)
...
- 14 housing units (gestation, farrowing, nursery, breeding, hospital, quarantine)
- 3 boars
- 50 sows in various stages:
  * 10 pregnant (various gestation stages)
  * 5 farrowing (currently nursing piglets)
  * 8 recently weaned (ready for next cycle)
  * 7 just bred (awaiting pregnancy confirmation)
  * 10 open/ready to breed
  * 5 with health issues
  * 5 high performers
- 17 breeding attempts
- 13 farrowing records
- ~125 piglets (nursing and weaned)
